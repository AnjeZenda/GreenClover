...
def get_info(request: HttpRequest):
    ...
    url = f'https://spb-afisha.gate.petersburg.ru/kg/external/afisha/events?lat={latitude | 59.939016}&lng={longitude | 30.31588}&radius={kilometers | 5}&fields=categories%2Cdescription%2Cplace%2Ctitle%2Cage_restriction%2Cis_free%2Cimages%2Cprice%2Cdates&expand=images%2Cplace%2Clocation%2Cdates%2Cparticipants&page=1&count=10&is_free={is_free}&actual_since={start}'
