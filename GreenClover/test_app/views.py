...
def get_info(request, lang='ru', order_by='slug', fields='id,slug,name'):
    url = 'https://spb-afisha.gate.petersburg.ru/kg/external/afisha/events?lat=59.939016&lng=30.31588&radius=5&fields=categories%2Cdescription%2Cplace%2Ctitle%2Cage_restriction%2Cis_free%2Cimages%2Cprice&expand=images%2Cplace%2Clocation%2Cdates%2Cparticipants&page=2&count=10'
